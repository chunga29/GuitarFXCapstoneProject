...
void Guitarfxcapstone4AudioProcessorEditor::paint (juce::Graphics& g)
{
    ...
    g.drawText("Attack", ((getWidth() / 7) * 1) - (100 / 2), (getHeight() / 6) + 10, 100, 100, Justification::centred, false);
    g.drawText("Release", ((getWidth() / 7) * 2) - (100 / 2), (getHeight() / 6) + 10, 100, 100, Justification::centred, false);
    g.drawText("Threshold", ((getWidth() / 7) * 3) - (100 / 2), (getHeight() / 6) + 10, 100, 100, Justification::centred, false);
    g.drawText("Gain", ((getWidth() / 7) * 4) - (100 / 2), (getHeight() / 6) + 10, 100, 100, Justification::centred, false);

    g.drawText("Drive", ((getWidth() / 7) * 1) - (100 / 2), 2 * (getHeight() / 6) + 10, 100, 100, Justification::centred, false);
    g.drawText("Range", ((getWidth() / 7) * 2) - (100 / 2), 2 * (getHeight() / 6) + 10, 100, 100, Justification::centred, false);
    g.drawText("Blend", ((getWidth() / 7) * 3) - (100 / 2), 2 * (getHeight() / 6) + 10, 100, 100, Justification::centred, false);
    g.drawText("Volume", ((getWidth() / 7) * 4) - (100 / 2), 2 * (getHeight() / 6) + 10, 100, 100, Justification::centred, false);

    g.drawText("Feedback", ((getWidth() / 7) * 1) - (100 / 2), 3 * (getHeight() / 6) + 10, 100, 100, Justification::centred, false);
    g.drawText("Time", ((getWidth() / 7) * 2) - (100 / 2), 3 * (getHeight() / 6) + 10, 100, 100, Justification::centred, false);
    g.drawText("Volume", ((getWidth() / 7) * 3) - (100 / 2), 3 * (getHeight() / 6) + 10, 100, 100, Justification::centred, false);

    g.drawText("Low", ((getWidth() / 7) * 1) - (100 / 2), 4 * (getHeight() / 6) + 10, 100, 100, Justification::centred, false);
    g.drawText("Mid", ((getWidth() / 7) * 2) - (100 / 2), 4 * (getHeight() / 6) + 10, 100, 100, Justification::centred, false);
    g.drawText("High", ((getWidth() / 7) * 3) - (100 / 2), 4 * (getHeight() / 6) + 10, 100, 100, Justification::centred, false);
}
...
void Guitarfxcapstone4AudioProcessorEditor::resized()
{
    ...
    attackKnob->setBounds(((getWidth() / 7) * 1) - (100 / 2), (getHeight() / 6) - (100 / 2), 100, 100);
    releaseKnob->setBounds(((getWidth() / 7) * 2) - (100 / 2), (getHeight() / 6) - (100 / 2), 100, 100);
    threshKnob->setBounds(((getWidth() / 7) * 3) - (100 / 2), (getHeight() / 6) - (100 / 2), 100, 100);
    compGainKnob->setBounds(((getWidth() / 7) * 4) - (100 / 2), (getHeight() / 6) - (100 / 2), 100, 100);
    // ratioMenu->setBounds(((getWidth() / 7) * 5) - (100 / 2), (getHeight() / 3) - (100 / 2), 100, 100);

    driveKnob->setBounds(((getWidth() / 7) * 1) - (100 / 2), 2 * (getHeight() / 6) - (100 / 2), 100, 100);
    rangeKnob->setBounds(((getWidth() / 7) * 2) - (100 / 2), 2 * (getHeight() / 6) - (100 / 2), 100, 100);
    blendKnob->setBounds(((getWidth() / 7) * 3) - (100 / 2), 2 * (getHeight() / 6) - (100 / 2), 100, 100);
    volumeKnob->setBounds(((getWidth() / 7) * 4) - (100 / 2), 2 * (getHeight() / 6) - (100 / 2), 100, 100);

    delayFeedbackKnob->setBounds(((getWidth() / 7) * 1) - (100 / 2), 3 * (getHeight() / 6) - (100 / 2), 100, 100);
    delayTimeKnob->setBounds(((getWidth() / 7) * 2) - (100 / 2), 3 * (getHeight() / 6) - (100 / 2), 100, 100);
    delayVolumeKnob->setBounds(((getWidth() / 7) * 3) - (100 / 2), 3 * (getHeight() / 6) - (100 / 2), 100, 100);

    lowKnob->setBounds(((getWidth() / 7) * 1) - (100 / 2), 4 * (getHeight() / 6) - (100 / 2), 100, 100);
    midKnob->setBounds(((getWidth() / 7) * 2) - (100 / 2), 4 * (getHeight() / 6) - (100 / 2), 100, 100);
    highKnob->setBounds(((getWidth() / 7) * 3) - (100 / 2), 4 * (getHeight() / 6) - (100 / 2), 100, 100);
}
